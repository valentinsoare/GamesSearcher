...
//        GamesSearcher gamesSearcher = new GamesSearcher();
//
//        List<String> bestGamesInDescendingOrder = execute(gamesSearcher);
//
//        System.out.printf("%n%s", bestGamesInDescendingOrder);
